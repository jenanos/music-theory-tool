        ...
        <>
            ...
            >
                <div className="flex flex-col gap-3 md:flex-row md:items-start md:gap-4">
                    ...
                    <div className="flex w-full shrink-0 flex-col gap-2 md:w-32">
                                        ...
                                        {!isCustomLabel ? (
                                            ...
                                            <div className="flex w-full items-center gap-1">
                                                ...
                                                <button
                                                    ...
                                                    className="rounded bg-muted p-1.5 text-muted-foreground hover:bg-muted/80 hover:text-foreground"
                    ...
                    <div className="min-w-0 flex-1">
                        <div className="flex flex-col gap-2">
                            ...
                            {section.notes && showNotes && (
                                <div className="rounded border border-border bg-muted px-3 py-2 text-sm italic text-muted-foreground">
                                    {section.notes}
                                </div>
                            )}
                        </div>
