            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
                {filtered.length === 0 ? (
                    ...
                    filtered.map((item, idx) => (
                        <button
                            className="flex flex-col justify-between rounded-xl border border-border bg-card p-4 text-sm text-foreground shadow-sm transition-all hover:border-primary/30 hover:bg-muted text-left"
