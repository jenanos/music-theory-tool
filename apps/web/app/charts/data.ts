...
export const initialSongs: Song[] = [
...

    {
        ...
        key: "E dorisk",
        notes:
            "Analysert som E dorisk. E♭ og Cm tolkes som lånte akkorder.",
        sections: [
            {
                id: "verse",
                label: "Vers",
            ...
            },
            {
                id: "chorus",
                label: "Ref",
                chordLines: ["G - Bm - C", "E♭ - Cm - G", "Bm - C", "Am7 - Bm - Em"],
                degreeLines: ["♭III - v - ♭VI", "♭II - ♭vi - ♭III", "v - ♭VI", "iv7 - v - i"],
                notes:
...

    {
        ...
        sections: [
            ...
            },
            {
                ...
                chordLines: ["Am - F", "Dm - Gsus4 - G", "Am - F", "Dm - G5 - B/D♯"],
                degreeLines: ["iv - ♭II", "♭vii - III - III", "iv - ♭II", "♭vii - III - V6"],
                notes:
...

    {
        ...
        sections: [
            ...
            },
            {
                ...
                notes: "Slash-akkorder på A indikerer basslinje/pedal på A i den linja."
            },
            {
                id: "outro",
                label: "Outro",
