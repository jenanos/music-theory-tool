...
function SortableItem(props: {
    ...
    return (
        <div
            ...
            {...attributes}
            {...listeners}
            className={`flex-shrink-0 cursor-grab rounded-md border border-border bg-card px-3 py-2 text-sm font-medium text-foreground shadow-sm hover:border-primary active:cursor-grabbing ${isDragging ? "opacity-50 z-50 ring-2 ring-primary" : ""
                }`}
        >
            {props.label}
        </div>
